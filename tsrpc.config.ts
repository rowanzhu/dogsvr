...
const tsrpcConf: TsrpcConfig = {
    ...
    proto: [
        {
            ptlDir: 'src/main_thread/conn_layer/tsrpc_cl/shared/protocols', // Protocol dir
            output: 'src/main_thread/conn_layer/tsrpc_cl/shared/protocols/serviceProto.ts', // Path for generated ServiceProto
            apiDir: 'src/main_thread/conn_layer/tsrpc_cl/api',   // API dir
            docDir: 'src/main_thread/conn_layer/tsrpc_cl/docs',     // API documents dir
